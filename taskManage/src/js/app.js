...
class StudentTaskManager {
  constructor() {
    this.storageKey = 'student_task_system_v2_data';
    this.state = null;
    this.filterKeyword = '';
    this.isCompactMode = false;
    this.perspective = 'teacher'; // 'teacher' (教师视角) 或 'student' (学生视角)
    const userPicked = localStorage.getItem('task_system_seat_shape_picked');
    this.seatShape = userPicked ? (localStorage.getItem('task_system_seat_shape') || 'flower') : 'flower'; // 默认'flower' (花瓣)
